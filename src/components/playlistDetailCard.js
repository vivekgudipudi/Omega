...
export const PlaylistDetailCard = ({video,playlist_id})=> {
    ...
    return(
        ...
        <div className="card-header card-header-vl">
            ...
            <div className=" justify-sb align-center flex-row"><div className='card-sub-title card-history' onClick={()=>{setShowModal(true);setBoolswitch((prev)=> !prev)}}><i class="fas fa-trash"></i></div>
            ...
            {showModal && <div>
                <button onClick={()=>{removeFromPlaylist(video,playlist_id);setBoolswitch((prev)=> !prev)}}>Delete</button>
